...
<body>
    ...
    <table>
        <tr>
            <td>Nama Barang</td> <td> :</td> <td>{{$item->nama}} </td>

        </tr>
        <tr>
            <td>Varian</td> <td> :</td> <td>{{$item->varian}} </td>

        </tr>
        <tr>

            <td>Harga Beli</td>  <td>:</td> <td>{{$item->harga_beli}}</td>
        </tr>
        <tr>
           <td>Harga Jual</td>  <td>:</td> <td>{{$item->harga_jual}}</td>
        </tr>
